...
_DEFAULT_THEMES = {
    'groups': {
        ...
        'semi_material': {'label': '半导体材料', 'color': '#ca8a04', 'symbols': ['688126', '002409', '300054', '688019', '300346', '605358', '300398', '688268', '688550', '600206']},
        'semi_equip':    {'label': '半导体设备', 'color': '#f59e0b', 'symbols': ['002371', '688012', '688072', '688082', '688120', '688037', '688361', '300604', '688200']},
        'chip_compute':  {'label': '算力芯片/GPU/ASIC', 'color': '#ef4444', 'symbols': ['688256', '688041', '300474', '688047', '688521', '688385', '002049', '688107']},
        'analog_chip':   {'label': '模拟/电源芯片', 'color': '#a855f7', 'symbols': ['300661', '688536', '688052', '688368', '688798', '688595', '603501', '688213']},
        'power_semi':    {'label': '功率半导体/IGBT', 'color': '#d946ef', 'symbols': ['603290', '600460', '605111', '300373', '688187', '688711', '688396']},
        'storage':       {'label': '存储芯片', 'color': '#06b6d4', 'symbols': ['603986', '300223', '688008', '301308', '001309', '688123']},
        'foundry':       {'label': '晶圆制造代工', 'color': '#8b5cf6', 'symbols': ['688981', '688347', '600171']},
        'packaging':     {'label': '封装测试', 'color': '#14b8a6', 'symbols': ['600584', '002156', '002185', '688362', '002079', '002436']},
        'passive':       {'label': '被动元件MLCC', 'color': '#2dd4bf', 'symbols': ['300408', '000636', '002138', '002859', '603678', '002484']},
        'server':        {'label': '服务器整机', 'color': '#3b82f6', 'symbols': ['000977', '601138', '603019', '000938', '000066']},
        'optical':       {'label': '光模块/光器件', 'color': '#22c55e', 'symbols': ['300308', '300502', '300394', '002281', '688498', '300570', '300620', '688313', '603083']},
        'fiber_cable':   {'label': '光纤光缆', 'color': '#16a34a', 'symbols': ['601869', '600487', '600522', '600498', '000070', '600105']},
        'pcb':           {'label': 'PCB算力板', 'color': '#7c3aed', 'symbols': ['002463', '002916', '300476', '002384', '002938', '603228']},
        'connector':     {'label': '铜连接/高速铜缆', 'color': '#ec4899', 'symbols': ['002475', '688629', '688668', '300679', '002130', '300563']},
        'cooling':       {'label': '液冷/散热', 'color': '#fb923c', 'symbols': ['002837', '301018', '300499', '300602', '300684']},
        'power_supply':  {'label': '电源/UPS配电', 'color': '#10b981', 'symbols': ['002851', '002335', '300870', '002518', '002364']},
